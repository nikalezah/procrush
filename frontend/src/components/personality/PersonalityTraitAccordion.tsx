...
import {LABEL_BAD_DAY, LABEL_GOOD_DAY, LABEL_SUCCEED_THROUGH, LABEL_TOP_STRENGTH,} from './personalityLabels'
          ...
          <div className="mt-4 flex flex-col gap-3 text-sm">
            <div className="flex flex-col gap-3 md:flex-row md:gap-4">
              <div className="min-w-0 flex-1 rounded-xl bg-white/80 p-3">
                <p className="font-medium text-stone-800">{LABEL_GOOD_DAY}</p>
                <p className="mt-0.5 text-stone-600">{trait.details.goodDay}</p>
              </div>
              <div className="min-w-0 flex-1 rounded-xl bg-white/80 p-3">
                <p className="font-medium text-stone-800">{LABEL_BAD_DAY}</p>
                <p className="mt-0.5 text-stone-600">{trait.details.badDay}</p>
              </div>
            </div>
            <div className="rounded-xl bg-white/80 p-3">
              <p className="font-medium text-stone-800">{LABEL_SUCCEED_THROUGH}</p>
