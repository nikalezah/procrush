...
INSERT INTO employers (user_id, name, description, website, phone, email_contact, updated_at) VALUES
    ('10000000-0000-4000-8000-000000000001', 'ТехНова',
    ...
    ('10000000-0000-4000-8000-000000000002', 'КлаудБридж',
    ...
    ('10000000-0000-4000-8000-000000000003', 'ДатаПульс',
    ...
    ('10000000-0000-4000-8000-000000000004', 'ДизайнМинт',
    ...
    ('10000000-0000-4000-8000-000000000005', 'АджайлВоркс',
...
INSERT INTO seekers (user_id, first_name, middle_name, last_name, phone, telegram, linkedin, updated_at) VALUES
    ('20000000-0000-4000-8000-000000000001', 'Иван',     'Сергеевич',  'Петров',    '+7 (916) 100-01-01', '@ipetrov',    'https://linkedin.com/in/ipetrov',    NOW()),
    ('20000000-0000-4000-8000-000000000002', 'Мария',    'Александровна', 'Сидорова', '+7 (903) 100-02-02', '@msidorova',  'https://linkedin.com/in/msidorova',  NOW()),
    ('20000000-0000-4000-8000-000000000003', 'Алексей',  'Дмитриевич', 'Козлов',   '+7 (926) 100-03-03', '@akozlov',    'https://linkedin.com/in/akozlov',    NOW()),
    ('20000000-0000-4000-8000-000000000004', 'Елена',    'Игоревна',   'Волкова',   '+7 (977) 100-04-04', '@evolkova',   'https://linkedin.com/in/evolkova',   NOW()),
    ('20000000-0000-4000-8000-000000000005', 'Дмитрий',  'Павлович',   'Орлов',     '+7 (915) 100-05-05', '@dorlov',     'https://linkedin.com/in/dorlov',     NOW()),
    ('20000000-0000-4000-8000-000000000006', 'Анна',     'Викторовна', 'Морозова',  '+7 (981) 100-06-06', '@amorozova',  'https://linkedin.com/in/amorozova',  NOW()),
    ('20000000-0000-4000-8000-000000000007', 'Сергей',   'Николаевич', 'Лебедев',   '+7 (905) 100-07-07', '@slebedev',   'https://linkedin.com/in/slebedev',   NOW()),
    ('20000000-0000-4000-8000-000000000008', 'Ольга',    'Андреевна',  'Соколова',  '+7 (967) 100-08-08', '@osokolova',  'https://linkedin.com/in/osokolova',  NOW()),
    ('20000000-0000-4000-8000-000000000009', 'Никита',   NULL,         'Фролов',    '+7 (999) 100-09-09', '@nfrolov',    NULL,                                 NOW()),
    ('20000000-0000-4000-8000-000000000010', 'Виктория', 'Олеговна',   'Романова',  NULL,                 NULL,          'https://linkedin.com/in/vromanova',  NOW());
